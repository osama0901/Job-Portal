  ...
  return (
    <div>
        ...
        <div className="w-full space-y-4">
            ...
            <input type="submit" value="Subscribe!" className="w-full-block px-5  py-2 pl-3 border focus:outline-none bg-sky-500 rounded-sm text-white cursor-pointer font-semibold"/>
        </div>
...
<input type="submit" value={"Uploaad your Resume"} className="w-full-block px-5  py-2 pl-3 border focus:outline-none bg-sky-500 rounded-sm text-white cursor-pointer font-semibold"/>
</div>
